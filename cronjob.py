	...
	with app.app_context():
		...
		try:
			...
			for ti_val in ti:
				...
				f_name=fetch_data[0][4]
				l_name=fetch_data[0][5]
				comp_name=fetch_data[0][6]
				sanction_amount=fetch_data[0][7]
				emi_amount_received=fetch_data[0][8]
